...
*This is the first post in a three part series on my PhD work about information freshness in shared memory systems. The [second post](/blog/2026/the-router-that-measured-freshness/) takes the question to a packet forwarding testbed, and the [third](/blog/2026/freshness-has-a-memory-bill/) measures what freshness costs in memory.*
