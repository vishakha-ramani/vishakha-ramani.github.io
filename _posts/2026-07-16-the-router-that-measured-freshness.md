...
*This is the second post in a three part series on my PhD work about information freshness in shared memory systems. The [first post](/blog/2026/a-lock-can-make-data-fresher/) analyzed how synchronization primitives shape freshness, and the [third](/blog/2026/freshness-has-a-memory-bill/) measures what freshness costs in memory.*
